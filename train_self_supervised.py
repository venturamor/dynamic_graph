...
parser.add_argument('--prefix', type=str, default='run', help='Prefix to name the checkpoints')
...
MODEL_SAVE_PATH = f'./saved_models/{0}-{1}.pth'.format(args.prefix, args.data)
